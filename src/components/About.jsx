...
const About = () => {
  ...
  return (
    <>
      <section className="about-me py-6" id="about">
        <h1
        ...
        <div className="inner-about-me flex flex-col md:flex-row items-center justify-between px-4 md:px-8 lg:px-4">
          <div className="row1 mb-8 md:mb-0 md:w-1/2 lg:w-1/3">
            <img
              src={picture}
              alt="my-pic"
              className="rounded-2xl shadow-xl w-full h-[20rem] md:h-[20rem] lg:h-[24rem] object-cover"
            />
          </div>
            ...
            <div className="inner-row-container bg-white rounded-xl p-6 shadow-lg">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <p>
                    <span className="font-bold text-primary">Age:</span> 27
                  </p>
                  <p>
                  ...
                  <p>
                    ...
                    Full-Stack Blockchain/AI powered Apps Developer
                  </p>
                  <p>
                    <span className="font-bold text-primary">Hobbies:</span>{" "}
                    Reading, travelling, coding, music art, documentaries,
                    history, research, podcasts.
                  </p>
                </div>
                <div className="space-y-4">
                  <p>
        ...
        <div className="skill__section mt-12 px-4 md:px-8 lg:px-16">
          <div className="skillsbox text-center">
            <h1 className="text-3xl md:text-4xl font-bold mb-8" ref={ref}>
              <span>MY</span> SKILLS
            </h1>
          </div>
          ...
          <div className="about-skills">
            ...
            <div className="box-container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
              <div className="box p-6 bg-white rounded-xl shadow-lg text-center">
