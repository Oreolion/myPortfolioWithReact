...
const Header = () => {
  ...
  return (
    <>
      ...
      { header && (<header className={isToggle ? "header active" : `header ${closeBtn} ? " collapsebtn " : "" `} ref={myRef}>
      ...
      <div>
        { !closeBtn ? (
          <button onClick={handleMenuBtn} className={`${closeBtn ? "close-btn" : "onclose-btn "}`}>
            {closeBtn ? "<" : ">"}
          </button>
        ) : (
          <>
